    ...
    hdrs = select(
        {
            ...
            "@bazel_tools//tools/python:PY3": glob(["local/lib/python3.6/dist-packages/numpy/core/include/python3.5/*.h"]),
        },
    ...
    includes = select(
        {
            ...
            "@bazel_tools//tools/python:PY3": ["local/lib/python3.6/dist-packages/numpy/core/include/python3.5"],
        },
        no_match_error = "Internal error, Python version should be one of PY2 or PY3",
    ),
